                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('conferences.store') }}">
                            ...
                            <div class="form-group row">
                                <label for="participant_number" class="col-md-4 col-form-label text-md-right">{{ __('Participant Number') }}</label>

                                <div class="col-md-6">
                                    <input id="participant_number" type="number" class="form-control @error('participant_number') is-invalid @enderror" name="participant_number" value="{{ old('participant_number') }}" required autocomplete="participant_number">
